...
def label_encoder_hierarchial_rf_function():
    return label_encoder_hierarchial_rf

"""##**Heirarchial Model 1 (Random Forest as Global Model and Random Forest as Top-k Model)**"""
...
def predict_with_top3_model_1(X_test, model_top3, combination_models, all_classes):
...
pickle.dump(model_top3_1, open("heirarchial_model_1.pkl", "wb"))