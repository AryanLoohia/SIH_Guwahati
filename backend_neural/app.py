...
import warnings
from model import label_encoder_nn_function
...
def predict():
    ...
    try:
        ...
        label_encoder_nn = label_encoder_nn_function()
        prediction = label_encoder_nn.inverse_transform([np.argmax(x) for x in prediction])
        print(prediction)
